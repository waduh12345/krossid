  ...
  return (
    <div className="bg-[#FDFCFB] min-h-screen">
      ...
      <section className="bg-[#024BA6] pt-20 pb-40 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="text-4xl lg:text-6xl font-black text-white mb-6 leading-tight">
            Konsultasikan Masa <br/><span className="text-[#F59E0B]">Depanmu Bersama Kami</span>
          </h1>
          <p className="text-white/80 max-w-2xl mx-auto text-lg font-light leading-relaxed">
            Punya pertanyaan tentang program kami atau ingin mencoba Free Trial? Tim konsultan pendidikan Qubic siap melayani Anda sepenuh hati.
          </p>
        </div>
      </section>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3 flex flex-col gap-6">
            <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-gray-100 group hover:border-[#024BA6] transition-all">
                ...
                <h4 className="font-bold text-xl text-[#024BA6] mb-2">WhatsApp Admin</h4>
                <p className="text-gray-500 text-sm mb-4">Respon cepat setiap Senin-Sabtu (08:00 - 17:00)</p>
                <a href="https://wa.me/6281234567890" className="text-[#D4420C] font-bold hover:underline">+62 812-3456-7890</a>
            </div>
            ...
            <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-gray-100 group hover:border-[#F59E0B] transition-all">
                ...
                <h4 className="font-bold text-xl text-[#024BA6] mb-2">Email Layanan</h4>
                <p className="text-gray-500 text-sm mb-4">Untuk pengajuan kerjasama dan pertanyaan formal.</p>
                <span className="text-[#D4420C] font-bold">halo@qubicbanguncita.com</span>
            </div>
            ...
            <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-gray-100 group hover:border-[#D4420C] transition-all">
                ...
                <h4 className="font-bold text-xl text-[#024BA6] mb-2">Kantor Pusat</h4>
                <p className="text-gray-500 text-sm leading-relaxed">
                    Jl. Pendidikan No. 123, Kawasan Edukasi Utama, Jakarta Pusat.
                </p>
            </div>
          </div>
          ...
          <div className="lg:w-2/3">
            <div className="bg-white p-8 lg:p-12 rounded-[3rem] shadow-2xl border border-gray-100">
              <h3 className="text-3xl font-black text-[#024BA6] mb-8 italic">Titip Pesan untuk Qubic</h3>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-tighter">Nama Lengkap Siswa/Orang Tua</label>
                    <input 
                        type="text" 
                        required
                  ...
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-tighter">Nomor WhatsApp Aktif</label>
                    <input 
                        type="tel" 
                        required
                        className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:border-[#F59E0B] transition-all text-sm"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-tighter">Kelas Saat Ini</label>
                    <input 
                        type="text" 
                        required
                        className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:border-[#F59E0B] transition-all text-sm"
                  ...
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-tighter">Program yang Diminati</label>
                    <select 
                ...
                <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-tighter">Pesan atau Pertanyaan</label>
                    <textarea 
                        rows={4}
                ...
                <p className="text-center text-xs text-gray-400 mt-4 italic">
                    *Tim kami akan membalas pesan Anda dalam kurun waktu kurang dari 24 jam.
                </p>
              </form>
            </div>
          </div>
      ...
      <section className="py-12 container mx-auto px-6">
        <div className="relative h-[450px] w-full rounded-[3.5rem] overflow-hidden shadow-2xl border-8 border-white">
            ...
            <div className="absolute top-6 left-6 bg-[#024BA6] text-white px-6 py-4 rounded-2xl shadow-xl hidden md:block animate-fadeIn">
                <h5 className="font-bold text-sm mb-1 uppercase tracking-widest">Kunjungi Kami Langsung</h5>
                <p className="text-[10px] opacity-70">Senin - Sabtu | 08:00 - 17:00 WIB</p>
            </div>
        </div>
      </section>
      ...
      <section className="py-24 container mx-auto px-6 max-w-4xl">
        <h2 className="text-3xl font-black text-[#024BA6] text-center mb-12 italic underline decoration-[#F59E0B] underline-offset-8">Pertanyaan Umum (FAQ)</h2>
        <div className="space-y-4">
           {[
             { q: "Apakah ada program Free Trial?", a: "Tentu! Kamu bisa mengikuti 1 sesi Free Trial di setiap program pilihanmu secara gratis." },
             { q: "Bagaimana sistem pembayarannya?", a: "Kami menerima transfer bank, e-wallet, hingga cicilan bulanan untuk program paket tertentu." },
             { q: "Apa legalitas Qubic?", a: "Qubic Bangun Cita adalah lembaga bimbingan belajar legal yang terdaftar di bawah pengawasan dinas pendidikan terkait." }
           ].map((faq, i) => (
             <details key={i} className="group bg-white p-6 rounded-2xl border border-gray-100 hover:border-[#024BA6] cursor-pointer">
