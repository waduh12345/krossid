                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex flex-col gap-3 mt-2 md:hidden">
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-center gap-2.5 px-5 py-3.5 rounded-xl bg-[#25D366]/15 hover:bg-[#25D366]/25 border border-[#25D366]/40 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                        >
                          {isSharingToWhatsApp ? (
