                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex flex-col gap-3 mt-2 md:hidden">
                        {/* WhatsApp full-width + Share icon button */}
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="flex-1 min-w-0 flex items-center justify-center gap-2.5 px-5 py-3.5 rounded-xl bg-[#25D366]/15 hover:bg-[#25D366]/25 border border-[#25D366]/40 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                          >
                            {isSharingToWhatsApp ? (
                              <Loader2 className="w-6 h-6 text-[#25D366] animate-spin" />
                            ) : (
                              <svg className="w-6 h-6 shrink-0 text-[#25D366]" viewBox="0 0 24 24" fill="currentColor">
                          ...
                          <div className="relative" ref={shareDropdownMobileRef}>
                            <button
                              ...
                              className="shrink-0 w-12 h-12 flex items-center justify-center rounded-xl bg-white/5 hover:bg-white/10 border border-white/20 transition-all"
                            >
                                ...
                                >
                                  ...
                                  >
                                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
                                      <radialGradient id="ig-m2" cx="50%" cy="50%" r="80%">
                                        <stop offset="0%" stopColor="#f9ce34"/>
                                        <stop offset="50%" stopColor="#ee2a7b"/>
                                        <stop offset="100%" stopColor="#6228d7"/>
                                      </radialGradient>
                                      <rect x="2" y="2" width="20" height="20" rx="6" fill="url(#ig-m2)" />
