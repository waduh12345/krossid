...
const services = [
  {
    ...
    category: "SD - SMP - SMA",
    description: "Fokus pada penguasaan konsep dasar dan peningkatan nilai rapor sekolah secara signifikan.",
    features: ["Pendampingan PR & Tugas", "Persiapan Ulangan Harian", "Modul Materi Sesuai Kurikulum Sekolah", "Laporan Perkembangan Bulanan"],
    icon: "fa-book-open",
    color: "#024BA6",
  ...
  },
  {
    ...
    description: "Program intensif yang dirancang khusus untuk menaklukkan soal-soal TKA dan lolos ke PTN favorit.",
    features: ["Bank Soal Terupdate", "Try Out Rutin Berkala", "Bedah Strategi Lolos PTN", "Konsultasi Pemilihan Jurusan"],
  ...
  },
  {
    ...
    description: "Pendampingan lengkap bagi siswa yang bermimpi melanjutkan studi di universitas terbaik dunia.",
    features: ["Persiapan IELTS/TOEFL/SAT", "Personal Statement Mentoring", "Workshop Beasiswa Luar Negeri", "Bimbingan Aplikasi PTLN"],
    icon: "fa-globe-americas",
    color: "#F59E0B",
    image: "https://images.unsplash.com/photo-1523050335392-93851179ae22?q=80&w=2071"
  }
];
      ...
      <section className="bg-[#024BA6] pt-20 pb-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <h1 className="text-4xl lg:text-6xl font-extrabold text-white mb-6">
            Layanan Terbaik untuk <br/><span className="text-[#F59E0B]">Masa Depanmu</span>
          </h1>
          <p className="text-white/80 max-w-2xl mx-auto text-lg lg:text-xl font-light">
            Dari peningkatan nilai rapor hingga persiapan kampus luar negeri, Qubic hadir dengan metode Fun Learning yang telah teruji.
          </p>
        </div>
      </section>
            ...
            >
              ...
              <div className="lg:w-1/2 relative h-[300px] lg:h-auto overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6 lg:hidden">
                    <span className="bg-[#F59E0B] text-white px-4 py-1 rounded-full text-xs font-bold uppercase">{service.category}</span>
                </div>
              </div>
              ...
              <div className="lg:w-1/2 p-10 lg:p-16 flex flex-col justify-center">
                <div className="hidden lg:block mb-4">
                    <span className="text-[#D4420C] font-bold tracking-widest text-sm uppercase">{service.category}</span>
                </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-5xl font-extrabold text-[#024BA6] mb-4">Metode Fun Learning Kami</h2>
            <div className="w-24 h-2 bg-[#F59E0B] mx-auto rounded-full"></div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Kurikulum Adaptif", desc: "Menyesuaikan dengan kecepatan belajar tiap siswa.", icon: "fa-sync-alt" },
              { title: "Mentor Asik", desc: "Pengajar muda berprestasi yang berperan sebagai kakak mentor.", icon: "fa-users" },
              { title: "Visual & Digital", desc: "Pembelajaran menggunakan aset visual dan platform CBT.", icon: "fa-laptop-code" },
              { title: "Evaluasi Rutin", desc: "Progress report transparan untuk orang tua & siswa.", icon: "fa-chart-line" }
            ].map((item, i) => (
              <div key={i} className="group p-8 rounded-3xl border border-gray-100 hover:border-[#F59E0B] hover:shadow-xl transition-all duration-300">
      ...
      <section className="py-20 container mx-auto px-6">
        <div className="bg-[#D4420C] rounded-[3rem] p-10 lg:p-20 text-white flex flex-col lg:flex-row items-center justify-between gap-10 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 lg:w-2/3 text-center lg:text-left">
                <h2 className="text-3xl lg:text-5xl font-bold mb-6 italic">Belum yakin memilih program yang mana?</h2>
                <p className="text-white/80 text-lg lg:text-xl font-light">
                    Jangan khawatir! Tim konsultan pendidikan Qubic siap membantu memetakan jalur pendidikan terbaik untukmu.
                </p>
            </div>
