...
export default function AffiliateLayout({
  ...
  // 3. Helper function untuk menentukan style aktif
  const getLinkClass = (path: string) => {
    // Style aktif (seperti style 'Feed' di kode awal Anda)
    const activeStyle = "text-[#4A90E2] border-b-2 border-[#4A90E2] pb-1";
    // Style tidak aktif
    const inactiveStyle = "hover:text-[#4A90E2] transition-colors";

    // Cek apakah pathname saat ini sama dengan path link atau diawali dengan path link (untuk sub-halaman)
    ...
    <section className="bg-[#F4F2EE] min-h-screen font-sans text-[#1A1A1A]">
      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          ...
          {/* 4. Terapkan function getLinkClass di sini */}
