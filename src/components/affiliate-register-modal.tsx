      ...
      <div className="bg-white dark:bg-neutral-900 w-full max-w-lg rounded-[2.5rem] overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <div className="relative bg-[#4A90E2] p-8 text-white">
          ...
          <p className="text-blue-100 text-xs mt-2 italic">
            Step {step} of 2:{" "}
            {step === 1 ? "Verify Identity" : "Marketing Strategy"}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8">
          {step === 1 ? (
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <div className="relative flex items-center">
                        <span className="absolute left-4 text-sm font-bold text-gray-500">
                          +62
                        </span>
                        <Input
                          placeholder="812xxx"
                          className="pl-12 h-12 rounded-xl bg-gray-50 border-gray-100"
            ...
            <div className="space-y-4 animate-in slide-in-from-right-4 duration-300">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  placeholder="How will you promote this program?"
                  className="w-full p-4 text-sm rounded-xl bg-gray-50 border-gray-100 focus:ring-1 focus:ring-[#4A90E2] focus:outline-none min-h-[100px]"
          ...
          <p className="text-[10px] text-center text-gray-400 mt-6 font-medium px-4">
            {isLoggedIn
              ? "You are applying using your logged-in profile."
              : "By applying, you will create a new account for this network."}
          </p>
        </form>
      </div>
    </div>
